"""
File       : benchmark_conf.py
Author     : Zygimantas Matonis
Description: Configuration file for benchmark.py script.
"""
...
finput = '/home/zygis/_Projektai/CERN/TransferMonitoring/Zygimantas/data/output/out120000.csv'
outpath = '../../data/output/'
atribute_drop_list = (
    ...
    'file_metadata|dst_type', 'file_metadata|request_id',
